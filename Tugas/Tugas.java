    ...
    public Tugas() {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(nama.equalsIgnoreCase("") && telepon.equalsIgnoreCase("") && alamat.equalsIgnoreCase("")) {
                    ...
                    JOptionPane.showMessageDialog(Tugas.this, "PASTIKAN SEMUA DATA SUDAH TERISI!", "Peringatan!",
                    JOptionPane.WARNING_MESSAGE);
                    return;
                } else {
                    // Jika nama bernilai kosong
                    if (nama.equalsIgnoreCase("")) {
                        JOptionPane.showMessageDialog(Tugas.this, "Nama tidak boleh kosong!", "Peringatan!",
                                JOptionPane.WARNING_MESSAGE);
                        return;
                    }
                    // Jika telepon bernilai kosong
                    if (telepon.equalsIgnoreCase("")) {
                        JOptionPane.showMessageDialog(Tugas.this, "Nomor telepon tidak boleh kosong!", "Peringatan!",
                                JOptionPane.WARNING_MESSAGE);
                        return;
                    }
                    // Jika alamat bernilai kosong
                    if (alamat.equalsIgnoreCase("")) {
                        JOptionPane.showMessageDialog(Tugas.this, "Alamat tidak boleh kosong!", "Peringatan!",
                                JOptionPane.WARNING_MESSAGE);
                        return;
                    }
                }
            ...
            "Masukan Data?", "Konfirmasi", JOptionPane.YES_NO_OPTION);
                 ...
                 if (confirmation == JOptionPane.YES_OPTION) {
                    ...
                    JOptionPane.showMessageDialog(Tugas.this, "Data tersimpan", "Informasi",
                            JOptionPane.INFORMATION_MESSAGE);
                } else {
                     JOptionPane.showMessageDialog(Tugas.this, "Data tidak tersimpan", "Peringatan!",
        ...
        buttonHapus.addActionListener(new ActionListener() {
            ...
            if (selectedRow >= 0) { // Pastikan baris dipilih adalah valid
                ...
                if (confirmation == JOptionPane.YES_OPTION) {
                    ...
                    JOptionPane.showMessageDialog(Tugas.this, "Data berhasil dihapus", "Informasi",
                            JOptionPane.INFORMATION_MESSAGE);
                }
            } else {
                //Menampilkan pesan peringatan "Pilih baris yang akan dihapus!"
                JOptionPane.showMessageDialog(Tugas.this, "Pilih baris yang akan dihapus!", "Peringatan!",
                        JOptionPane.WARNING_MESSAGE);
                }
            }
        });
        ...
        buttonEdit.addActionListener(new ActionListener() {
            ...
            if (!nama.isEmpty() && !telepon.isEmpty()) { // Pastikan nama dan telepon tidak kosong
                ...
                JOptionPane.showMessageDialog(Tugas.this, "Data berhasil diubah", "Informasi", JOptionPane.INFORMATION_MESSAGE);
            } else {
                //Menampilkan pesan peringatan ketika Nama dan Nomor Telepon kosong/tidak diisi
                JOptionPane.showMessageDialog(Tugas.this, "Nama dan Nomor Telepon tidak boleh kosong!", "Peringatan!", JOptionPane.WARNING_MESSAGE);
            }
        } else {
            //Menampilkan pesan peringatan "Pilih baris yang akan diubah!"
            JOptionPane.showMessageDialog(Tugas.this, "Pilih baris yang akan diubah!", "Peringatan!", JOptionPane.WARNING_MESSAGE);
               }
            }
        });
        ...
        buttonFile.addActionListener(new ActionListener() { // Mengatur aksi yang akan dijalankan saat tombol ditekan
            public void actionPerformed(ActionEvent e) {
                ...
                int userSelection = fileChooser.showSaveDialog(Tugas.this);
                ...
                if (userSelection == JFileChooser.APPROVE_OPTION) {
                    ...
                    JOptionPane.showMessageDialog(Tugas.this, "Data berhasil disimpan ke file", "Info", JOptionPane.INFORMATION_MESSAGE);
                }
            }
        });
