...
public class LatihanMyTableModel extends AbstractTableModel {
    ...
    public int getColumnCount() {
        // Mengembalikan panjang/ukuran dari array columnNames
        return columnNames.length;
    }
    
    // Fungsi untuk menambah jumlah baris
    public int getRowCount() {
        // Mengembalikan jumlah data yang diterima dari ArrayList data
        return data.size();
    }
    
    // Fungsi untuk mendapatkan nama dari kolom yang dipilih dari parameter
    public String getColumnName(int col) {
        // Mengembalikan elemen columnNames dengan index col
